...
void Game::init(int w, int h) {
    ...
    Shader* geometry_shader = graphics_system_.loadShader("data/shaders/phong.vert", "data/shaders/phong.frag");
    Shader* animation_shader = graphics_system_.loadShader("data/shaders/phong_anim.vert", "data/shaders/phong.frag");

   // Parsers::parseCollada("data/assets/gabi/Jazz_Dancing_Gabi.dae", animation_shader, graphics_system_);
